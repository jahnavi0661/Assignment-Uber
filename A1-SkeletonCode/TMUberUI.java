  ...
  public static void main(String[] args)
  {
    ...
    while (scanner.hasNextLine())
    {
      ...
      else if (action.equalsIgnoreCase("REQRIDE")) 
      {
        ...
        boolean rideRequested = tmuber.requestRide(accountId, from, to);
        if(rideRequested == false)
          System.out.println(tmuber.getErrorMessage());
        else{
          String username = tmuber.getUsernameFromId(accountId);
          System.out.println("Ride for: " + username + "    From: " + from + "    To: " + to);
        }           
      ...
      else if (action.equalsIgnoreCase("REQDLVY")) 
      {
        ...
        String  foodOrderId = scanner.nextLine().trim();

        boolean rideRequested = tmuber.requestDelivery(accountId, from, to, restaurant, foodOrderId);
        if(rideRequested == false)
          System.out.println(tmuber.getErrorMessage());
        else{
          String username = tmuber.getUsernameFromId(accountId);
          System.out.println("DELIVERY for: " + username + "     From: " + from + "   To: " + to);
        }
